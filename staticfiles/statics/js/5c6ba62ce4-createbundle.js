    ...
    127: function(e, t, n) {
        ...
        $(document).ready(function() {
            Object(s.priceAlert)($(".choose-price-alert").data("show-price")), p(), $(document).on("click", ".add-to-bundle", function() {
                ...
                var e, t, n, a, r = $(this).data("page");
                var csrftoken = getCookie('csrftoken');
                $(this).addClass("disabled").attr("disabled", "disabled").html('<i class="fa fa-circle-notch fa-spin"></i>');
                console.log("r:", r); // Log the value of 'r'
                ...
                // if ("create" !== r) {
                    ...
                    // o = $("#bundleId").val();
                    a = m();
                    console.log("e:", e); // Log the value of 'e'
                    console.log("t:", t); // Log the value of 't'
                    console.log("n:", n); // Log the value of 'n'
                    // console.log("o:", o); // Log the value of 'o'
                    ...
                    console.log("r:", r); // Log the value of 'r' after modification
                // }
            
                // $.ajax(f(r)).done(function(e) {
                //     if (!e || e.hasOwnProperty("error")) {
                //         $(".submitBundle").removeAttr("disabled").removeClass("disabled").html($("#BUNDLES_SAVE_BTN").val());
                //     } else {
                //         i(n, a.length);
                //         u.a.fire({
...
// Create a function to make the AJAX request
function makeAjaxRequest(data) {
    return fetch('/ajax-mvc/create-bundle-action/', {
        method: 'POST',
        headers: {
